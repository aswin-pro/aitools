...
namespace Plugins\TwilioWhatsappNotification\Controllers;
...
{
    public function twilioWhatsappNotificationSettings(Request $request)
    {
        // check database and create table if not exists
        if (! Schema::hasTable('twilio_whatsapp_notification_settings')) {
            // Create table
            Schema::create('twilio_whatsapp_notification_settings', function (Blueprint $table) {
                $table->id();
        ...
        // Check if table twilio_whatsapp_notification_templates exists
        if (! Schema::hasTable('twilio_whatsapp_notification_templates')) {
            // Create table
            Schema::create('twilio_whatsapp_notification_templates', function (Blueprint $table) {
                $table->id();
            ...
            DB::table('twilio_whatsapp_notification_templates')->insert([
                [
                    'id'            => 1,
        ...
        $twilio_whatsapp_notification_settings = DB::table('twilio_whatsapp_notification_settings')->first();

        // notification templates
        $twilio_whatsapp_notification_templates =
            DB::table('twilio_whatsapp_notification_templates')
            ->get()
            ->keyBy('template_name');
    ...
    public function twilioWhatsappNotificationSettingsUpdate(Request $request)
    {
        // Validate request
        $request->validate([
        ...
        // Update or insert
        DB::table('twilio_whatsapp_notification_settings')->updateOrInsert(
            ['id' => 1],
            [
        ...
        // forget cache
        cache()->forget('twilio_whatsapp_notification_settings');

        // redirect
        return redirect()->back()->with('success', __('Twilio Whatsapp Notification Settings updated successfully.'));
    }

    // Update Twilio Whatsapp Notification User Register Template
    public function twilioWhatsappTemplateUserRegisterUpdate(Request $request)
    {
        // validate request
    ...
    // Update Twilio Whatsapp Notification Plan Purchase Template
    public function twilioWhatsappTemplatePlanPurchaseUpdate(Request $request)
    {
        // validate request
        if ($r = $this->validateTemplate($request, [
    ...
    // Update Twilio Whatsapp Notification Plan Renewal Template
    public function twilioWhatsappTemplatePlanRenewalUpdate(Request $request)
    {
        // validate request
        if ($r = $this->validateTemplate($request, [
    ...
    // Update Twilio Whatsapp Notification Plan Expiry Template
    public function twilioWhatsappTemplateUserPlanExpiryRemainderUpdate(Request $request)
    {
        // Validate request
        if ($r = $this->validateTemplate($request, [
    ...
    // Update Twilio Whatsapp Notification Plan Expired Template
    public function twilioWhatsappTemplateUserExpiredUpdate(Request $request)
    {
        // Validate request
        if ($r = $this->validateTemplate($request, [
    ...
    private function validateTemplate(Request $request, array $rules)
    {
        ...
        if ($validator->fails()) {
            return redirect()
                ->route('admin.plugin.twilio_whatsapp_notification.settings')
