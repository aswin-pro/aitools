...
@php
    // get templates
    $templates = collect($twilio_sms_notification_templates)->keyBy('template_name');
                ...
                <div class="row g-2 align-items-center">
                    <div class="col">
                        ...
                        <h2 class="page-title mb-2">
                            {{ __('Twilio Sms Notification Settings') }}
                        </h2>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row row-deck row-cards">
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('admin.twilio_sms_notification_settings.update') }}" method="post"
                            class="card">
                            @csrf
                            <div class="card-header">
                                <h4 class="page-title">{{ __('Twilio Sms Notification Credentials') }}</h4>
                            </div>
                            <div class="card-body">
                                {{-- Twilio Settings --}}
                                <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="account_sid"
                                                        value="{{ isset($twilio_sms_notification_settings) ? $twilio_sms_notification_settings->account_sid ?? '' : '' }}"
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="auth_token"
                                                        value="{{ isset($twilio_sms_notification_settings) ? $twilio_sms_notification_settings->auth_token ?? '' : '' }}"
                                                        placeholder="{{ __('Auth Token') }}" required>
                                                </div>
                                            </div>
                                            {{-- Twilio Business Phone Number (with country code) --}}
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    <div class="form-label required">
                                                        {{ __('Twilio Business Sms Number (with country code)') }}
                                                    </div>
                                                    <input type="number" class="form-control" name="from_number"
                                                        value="{{ isset($twilio_sms_notification_settings) ? $twilio_sms_notification_settings->from_number ?? '' : '' }}"
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="admin_number"
                                                        value="{{ isset($twilio_sms_notification_settings) ? $twilio_sms_notification_settings->admin_number ?? '' : '' }}"
                                                        placeholder="{{ __('Phone Number') }}" required>
                                                </div>
                                            </div>
                                            <span>{{ __('If you did not get these credentials, create a') }}
                                                <a href="https://www.twilio.com/console"
                                                    target="_blank">{{ __('new Twilio Sms Notification Credentials.') }}</a>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-12 col-lg-12 card">
                        <div class="card-header">
                            <h4 class="page-title">{{ __('Twilio Sms Notification Templates And Controls') }}</h4>
                        </div>
                        <div class="card-body">
                                ...
                                @php
                                    ...
                                    $sections = [
                                        [
                                            ...
                                            'route' => 'admin.twilio_sms_template_user_register.update',
                                            'form_id' => 'myForm1',
                                            'blocks' => [
                                                [
                                                    'fields' => [
                                        ...
                                        [
                                            ...
                                            'route' => 'admin.twilio_sms_template_plan_purchase.update',
                                            'form_id' => 'myForm2',
                                            'blocks' => [
                                                [
                                                    'fields' => [
                                        ...
                                        [
                                            ...
                                            'route' => 'admin.twilio_sms_template_plan_renewal.update',
                                            'form_id' => 'myForm3',
                                            'blocks' => [
                                                [
                                                    'fields' => [
                                        ...
                                        [
                                            ...
                                            'route' => 'admin.twilio_sms_template_plan_expiry_remainder.update',
                                            'form_id' => 'myForm4',
                                            'alert' => true,
                                            'blocks' => [
                                                [
                                        ...
                                        [
                                            ...
                                            'route' => 'admin.twilio_sms_template_plan_expired_notification.update',
                                            'form_id' => 'myForm5',
                                            'alert' => true,
                                            'blocks' => [
                                                [
