...
<div class="accordion-item">
    {{-- User Plan Expiry Notification Form --}}
                ...
                <div class="row">
                    ...
                    @php
                        $sections = [
                            [
                                'title' => 'User',
                                'data' => $user_plan_expiry_remainder,
                                'decoded' => json_decode($user_plan_expiry_remainder->variables ?? '[]', true),
                                'tableId' => 'variablesTable6',
                                'inputId' => 'variablesInput6',
                                'inputName' => 'variables',
                                'key' => 'user',
                            ],
                        ];
                    ...
                    @foreach ($sections as $s)
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select tom-select" name="{{ $s['key'] }}_plan_expiry_remainder">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control"
                                name="{{ $s['key'] }}_plan_expiry_remainder_template_id"
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control"
                                name="{{ $s['key'] }}_plan_expiry_remainder_template_namespace"
