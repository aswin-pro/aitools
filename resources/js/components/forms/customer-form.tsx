...
import { Customer, FieldType } from '@/types';
...
export default function CustomerForm({ customer }: { customer?: Customer }) {
    ...
    const fields: FieldType[] = [
        ...
        },
        {
            ...
            props: {
                ...
                defaultValue: customer?.alternative_mobile_number,
                inputMode: 'numeric',
                pattern: '[0-9]*',
                onInput: (e: React.FormEvent<HTMLInputElement>) => {
                    e.currentTarget.value = e.currentTarget.value.replace(
        ...
        },
        {
            ...
            props: {
                ...
                defaultValue: customer?.business_address,
                required: true,
            },
        },
        {
        ...
        },
        {
            ...
            props: {
                ...
                defaultValue: customer?.bank_account_holder_name,
                required: false,
            },
        },
        {
        ...
        },
        {
            ...
            props: {
                ...
                defaultValue: customer?.ifsc_code,
                required: false,
            },
        },
        {
    ...
    return (
        <Form
            ...
            action={
                isEdit
                    ? route('dashboard.customers.update', customer.customer_id)
