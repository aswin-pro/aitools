...
import { FieldType, Product, Production, ProductionOutput } from '@/types';
...
export default function ProductionDeliveryForm({
    ...
    // prepare items
    const [items, setItems] = useState<ProductionOutput[]>(
    ...
    const columns: FieldType<ProductionOutput>[] = [
        {
            id: 'product_id',
            fieldType: 'select',
            props: {
                placeholder: t('Select Product'),
                options: all_products.map((allProduct) => ({
        ...
        },
        {
            ...
            inputGroup: {
                align: 'inline-end',
                content: (item: ProductionOutput) => getUnit(item.product_id),
            },
        },
    ];
    ...
    return (
        <Form
            method="put"
            action={route('dashboard.productions.update-status', {
