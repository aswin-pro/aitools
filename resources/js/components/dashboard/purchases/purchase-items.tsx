...
import { FieldType, Product, Purchase, PurchaseItem } from '@/types';
...
export default function PurchaseItems({
            ...
            prev.map((item, i) => {
                ...
                if (field === 'product_id') {
                    ...
                    return {
                        ...item,
                        product_id: value as string,
                        unit_price: roundToTwoDecimals(product.purchase_price),
    ...
    const [wholeDiscount, setWholeDiscount] = useState<number>(
        roundToTwoDecimals(purchase?.discount ?? 0),
    );
    ...
    const columns: FieldType<PurchaseItem>[] = [
        {
            id: 'product_id',
            fieldType: 'select',
            props: {
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="w-24 min-w-28 border-r">
                                {t('Tax (%)')}
                            </TableHead>
                            <TableHead className="w-32 min-w-32 border-r">
                                {t('Tax Amount')}
