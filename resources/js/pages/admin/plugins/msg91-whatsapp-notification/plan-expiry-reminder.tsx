...
export default function PlanExpiryReminder({
    template,
}: Props) {
    ...
    const form = useForm({
        ...
        user_plan_expiry_remainder_template_namespace:
            template?.namespace ?? "",
    ...
    const submit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        form.post(
            route(
                "admin.msg91_whatsapp_template_user_plan_expiry_remainder.update",
            ),
            {
                preserveScroll: true,
        ...
        <section className="space-y-6">
            <div>
                <h2 className="text-lg font-semibold">
                    {t("User Plan Expiry Remainder Notification")}
                </h2>
            </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                        ...
                        <div className="grid gap-2">
                            <Label
                                htmlFor="user_plan_expiry_remainder"
                                required
                            >
                                {t("Send Notification")}
                            </Label>
                        ...
                        {/* Namespace */}
                        <FormInput
                            id="user_plan_expiry_remainder_template_namespace"
                            name="user_plan_expiry_remainder_template_namespace"
