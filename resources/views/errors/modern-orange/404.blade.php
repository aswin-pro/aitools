<section class="relative py-6 md:py-16 lg:py-16 lg:px-16 overflow-hidden">
    <div class="relative container px-4 mx-auto">
        <div class="flex flex-wrap -mx-4 items-center justify-center">
            <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                <div class="max-w-md md:max-w-2xl lg:max-w-none mx-auto">
                    <h2 class="font-heading text-4xl xs:text-6xl font-bold text-gray-900 mb-12">
                        <span>{{ __('Currently Updating') }}-</span>
                        <span class="block font-serif italic">{{ __('Back soon') }}!</span>
                    </h2>
                    <div class="sm:flex max-w-sm sm:max-w-lg">
                        ...
                        <div class="max-w-md">
                            <p class="sm:text-xl text-gray-500 font-semibold mb-14">
                                {{ __('Sorry, the page you are looking for doesn\'t exist or has been moved. Try searching our site') }}:
                            </p>
                            <a class="relative group inline-block py-3 px-5 text-center text-sm font-semibold text-orange-50 bg-orange-900 rounded-full overflow-hidden"
                                ...
                                <span class="relative">{{ __('Take me home') }}</span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full lg:w-1/2 px-4">
              <img class="block mx-auto" src="{{ asset('themes/modern-orange/assets/images/http-codes/404-alien.png')}}" alt="">
            </div>
        </div>
    </div>
</section>
