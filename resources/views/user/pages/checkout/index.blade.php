            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            {{-- title --}}
                            <h3 class="card-title">{{ __('Purchase/Renewal Plan') }}</h3>
                                ...
                                <table class="table table-vcenter border">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div>
                                                    {{ __($plan->name) }} - {{ $plan->validity }}
                                                    {{ __('Days') }}
                                                </div>
                                            </td>
                                            <td class="text-bold">
                                                {{ $price == '0' ? 0 : formatCurrency($price, $config[1]->config_value) }}
                                            </td>
                                        </tr>
                                        @if ($config[25]->config_value > 0)
                                            <tr>
                                                ...
                                                <td class="text-bold">
                                                    {{ formatCurrency($tax_price, $config[1]->config_value) }}
                                                </td>
                                            </tr>
                                        @endif
                                        <tr>
                                            ...
                                            <td class="w-1 text-bold h3">
                                                {{ formatCurrency($total, $config[1]->config_value) }}</td>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                {{-- form --}}
                <div class="col-lg-8">
                    <form action="{{ route('prepare.payment.gateway', $plan->id) }}" method="post">
                        @csrf
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="row">
                                            {{-- title --}}
                                            <h2 class="card-title text-muted mb-3">{{ __('Billing Details') }}</h2>
                                            ...
                                            <div class="col-md-4 col-xl-4">
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label required">{{ __('Phone (with country code)') }}</label>
                                                    <input type="tel" class="form-control" name="billing_phone"
                                                        placeholder="{{ __('Ex: 91XXXXXXXXXX') }}"
                                            ...
                                            <div class="col-md-4 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="tomselected form-select"
                                                        value="{{ Auth::user()->billing_country }}" id="billing_country"
