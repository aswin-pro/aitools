                            ...
                            <table class="table table-vcenter">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-bold">{{ currency($selected_plan->price * $config[25]->config_value / 100) }}
                                        </td>
                                    </tr>
                                    @endif
                                    <tr>
                                        <td class="h3 text-bold"> {{ __('Total Payable') }} </td>
                                        <td class="w-1 text-bold h3">{{ currency($total) }}</td>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <div class="row">
                                    <div class="row">
                                        <h3 class="card-title text-muted mb-3">{{ __('Billing Details') }}</h1>
                                            ...
                                            <div class="col-md-4 col-xl-4">
                                                <div class="mb-3">
                                                    <label class="form-label required">{{ __('Phone (with country code)') }}</label>
                                            ...
                                            <div class="col-md-4 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="billing_address"
                                                        id="billing_address" cols="10" rows="2"
