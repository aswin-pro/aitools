            ...
            <div class="container-fluid">
                ...
                <div class="row row-deck row-cards">
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('admin.update.payment.configuration', $gateway_details->id) }}"
                            method="post" class="card">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    {{-- Paypal --}}
                                    @if ($gateway_details->id == 1)
                                        {{-- Mode --}}
                                        ...
                                        <div class=" col-md-6 col-xl-4">
                                            <div class="mb-3">
                                                ...
                                                <select type="text" class="form-select"
                                                    ...
                                                    <option value="sandbox"
                                                        {{ $config[64]->config_value == 'sandbox' ? 'selected' : '' }}>
                                                        {{ __('Sandbox') }}</option>
                                                    <option value="live"
                                                        {{ $config[64]->config_value == 'live' ? 'selected' : '' }}>
                                                        {{ __('Live') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    {{-- Transaction Cloud --}}
                                    @if ($gateway_details->id == 7)
                                        {{-- API Login --}}
                                        <div class="col-md-6 col-xl-4">
                                            <div class="mb-3">
                                                <label class="form-label required">{{ __('API Login') }}</label>
                                                <input type="text" class="form-control" name="transaction_cloud_login"
