                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table" id="currencies-table">
                                <thead>
                                    <tr>
                                        <th>{{ __('#') }}</th>
                                        <th>{{ __('Name') }}</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div id="delete_status" class="text-secondary">
                    {{ __('If you proceed, you will delete this currency data.')}}
                </div>
            </div>
        ...
        $('#currencies-table').DataTable({
            ...
            preDrawCallback: function(settings) {
                ...
                if ($('#currencies-table tbody tr').length === 0) {
                    ...
                    $('#currencies-table tbody').html(placeholderRows);
                }
            },
            drawCallback: function(settings) {
                // Remove the placeholder-glow class once the table is fully rendered
                $('#currencies-table_wrapper').removeClass('placeholder-glow');

                // clear any existing placeholder rows
                $('#currencies-table tbody tr').each(function() {
...
<script>
    ...
    function deleteCurrency(currencyId) {
        ...
        link.setAttribute("href", "/admin/delete-currency?id=" + currencyId);
    }
</script>
@endsection
@endsection