                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                ...
                                {{-- Logo --}}
                                <img src="{{ asset($settings->site_logo) }}" class="img-fluid mb-2" width="200"
                        ...
                        <table class="table table-borderless border">
                            ...
                            <tbody>
                                <tr class="fw-bold">
                                    <td>{{ __($planDetails->name) }} -
                                        {{ currency($planDetails->price) }}/{{ $term }}
                                    </td>
                                    <td class="text-end">1</td>
                                    <td class="text-end">
                                        {{ currency($planDetails->price) }}
                                    </td>
                                    <td class="text-end">
                                        {{ currency($planDetails->price) }}
                                    </td>
                            ...
                            <tfoot class="border-top fw-bold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        {{ currency($transaction->billing_details['subtotal']) }}
                                    </td>
                                </tr>
                                ...
                                @if ($transaction->billing_details['tax_amount'] > 0)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            {{ currency($transaction->billing_details['tax_amount']) }}
                                        </td>
                                    </tr>
                                @endif
                                ...
                                @if (isset($transaction->billing_details['applied_coupon']) != null)
                                    <tr>
                                        ...
                                        <td class="font-weight-bold text-end">
                                            -
                                            {{ currency($transaction->billing_details['discounted_price']) }}
                                        </td>
                                    </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <strong>{{ currency($transaction->billing_details['invoice_amount']) }}</strong>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        {{ currency($transaction->billing_details['invoice_amount']) }}
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        <p class="mt-5"><strong>{{ __('Notes') }}</strong>:<br><span
                                class="text-muted">{{ __('Payment from ' . $transaction->payment_gateway_name) }}<br>{{ __('Transaction ID: ') }}
                                {{ $transaction->transaction_id != '' ? $transaction->transaction_id : '-' }}</span>
                        </p>
