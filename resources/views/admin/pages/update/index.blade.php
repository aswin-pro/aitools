            ...
            <div class="container-fluid">
                ...
                <div class="row row-cards">
                        ...
                        <form action="{{ route('admin.check.update') }}" method="post" class="card">
                            ...
                            <div class="card-body mb-2">
                                <div class="row align-items-center gx-2">
                                    ...
                                    <!-- Submit Button -->
                                    <div
                                        class="col-lg-4 col-md-4 d-flex justify-content-lg-end justify-content-md-start mt-3 mt-lg-0">
                            ...
                            <div class="mt-3">
                                <div class="alert alert-success">
                                    ...
                                    @if ($response['update'])
                                        ...
                                        <p>{{ __('IMPORTANT: Before starting this process, we recommend you to take a backup of your files.') }}
                                        </p>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <!-- Piracy Warning -->
                        <a href="https://codecanyon.net/item/ai-tools-advanced-automatic-content-creating-and-image-generating-tool-saas-php/44122572?ref={{ urlencode(config('app.url')) }}&size=source"
                            target="_blank" rel="noopener noreferrer">
                            <img src="{{ asset('img/piracy.png') }}" alt="Piracy" class="mb-2 img-fluid">
                        </a>

                        <!-- Support Renewal -->
                        <a href="https://store.nativecode.in?ref={{ urlencode(config('app.url')) }}" target="_blank"
                        ...
                        @if (isset($response))
                            @if ($response['license'] == 'Regular License')
                                <a href="https://codecanyon.net/cart/configure_before_adding/44122572?license=extended&ref={{ urlencode(config('app.url')) }}&size=source"
                                    target="_blank" rel="noopener noreferrer">
