    ...
    <div class="container px-4 mx-auto">
        <div class="max-w-7xl py-10 xl:py-20 mx-auto">
            <div class="max-w-md mx-auto xl:mr-10 2xl:mr-0">
                <h3 class="font-heading text-4xl text-gray-900 font-semibold mb-4">{{ __('Reset your password') }}</h3>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            value="{{ $email ?? old('email') }}" placeholder="{{ __('Enter your email address') }}" required autocomplete="email" autofocus>
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            class="w-full py-3 px-4 text-sm text-gray-900 placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg"
                            type="password" class="form-control @error('password') is-invalid @enderror"  placeholder="{{ __('Password') }}" name="password" id="password"
                    ...
                    <div class="mb-4">
                        <label class="block mb-1.5 text-sm text-gray-900 font-semibold"
                            for="password-confirm">{{ __('Confirm Password') }} <span class="text-red-800">*</span></label>
                        <input
                            class="w-full py-3 px-4 text-sm text-gray-900 placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg"
                            type="password" class="form-control"  placeholder="{{ __('Confirm Password') }}" name="password_confirmation" id="password-confirm" required
